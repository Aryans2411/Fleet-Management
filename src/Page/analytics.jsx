...
import { FiActivity, FiDroplet, FiThermometer, FiZap, FiClock, FiTrendingUp, FiAlertCircle } from "react-icons/fi";
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <form onSubmit={handleSubmit} className="bg-gray-800/50 backdrop-blur-md p-8 rounded-xl border border-gray-700 shadow-2xl hover:shadow-green-500/10 transition-shadow duration-300">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            {[
              { label: "Engine RPM", name: "engine_rpm", icon: <FiActivity className="text-green-400" /> },
              { label: "Lubricant Oil Pressure", name: "lub_oil_pressure", icon: <FiDroplet className="text-blue-400" /> },
              { label: "Fuel Pressure", name: "fuel_pressure", icon: <FiZap className="text-yellow-400" /> },
              { label: "Coolant Pressure", name: "coolant_pressure", icon: <FiThermometer className="text-red-400" /> },
              { label: "Lubricant Oil Temperature", name: "lub_oil_temp", icon: <FiThermometer className="text-purple-400" /> },
              { label: "Coolant Temperature", name: "coolant_temp", icon: <FiThermometer className="text-pink-400" /> },
              { label: "Mileage", name: "mileage", icon: <FiTrendingUp className="text-indigo-400" /> },
              { label: "Fuel Consumption Rate", name: "fuel_consumption_rate", icon: <FiZap className="text-yellow-400" /> },
              { label: "Engine Runtime", name: "engine_runtime", icon: <FiClock className="text-blue-400" /> },
              { label: "Temperature Difference", name: "temperature_difference", icon: <FiThermometer className="text-green-400" /> },
            ].map((field, index) => (
            ...
            <div className="space-y-2">
              <label className="flex items-center text-sm font-medium text-gray-300">
                ...
                <span className="ml-2">Fuel Type</span>
              </label>
              <select
                name="fuel_type"
